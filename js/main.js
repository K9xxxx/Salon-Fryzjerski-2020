...
let goldenP = document.querySelectorAll(
  ".contact-con-abs-main.ccMobile .golden-p",
);
let vBorderMob = document.querySelectorAll(
  ".contact-con-abs-main.ccMobile .vertical-border",
);
...
tlIcons.to(icons[0], 0.2, { opacity: 1 });
tlIcons.to(icons[1], 0.2, { opacity: 1 });
tlIcons.to(icons[2], 0.2, { opacity: 1 });
tlIcons.to(icons[3], 0.2, { opacity: 1 });
tlIcons.to(icons[4], 0.2, { opacity: 1 });

tlMobCen.to(".cennik-banner.px800 .cennik-for", 0.3, { opacity: 1 });
tlMobCen.to(
  ".cennik-banner.px800 .cennik-square",
  0.3,
  { opacity: 1 },
  "+=0.3",
);
...
tlInitial.to(".contact-con-rel-main h4", 0, { opacity: 0 });
...
tlPos.to(".short-p", 0.3, { y: 0 });
tlPos.to(".short-p", 0.3, { y: 0 });
tlSwiper.to(".swiper.articles", 0.5, { opacity: 1 });
...
$(document).ready(function () {
  ...
  tlScene1.to(".abs.text-container-1", 0.6, { x: 0, opacity: 1, delay: 0.2 });
  tlScene1.to(".abs.text-container-2", 0.9, { x: 0, opacity: 1 }, "-=.2");
  tlScene1.to(".abs.text-container-3", 0.4, { opacity: 1 }, "-=.4");
  tlScene1.to(".abs.background-container", 3, { rotate: "90deg" }, "-=1.3");
  tlScene1.to(".img-container-after", 0.7, { opacity: 1 }, "-=2");
  ...
  let sec6text1 = new ScrollMagic.Scene({
    ...
    .setClassToggle(".contact-con-rel-main h4", "sm-left")
    .addTo(controller);
  ...
  let text1 = new ScrollMagic.Scene({
    ...
    .setClassToggle(
      ".about-us-info p:nth-child(1), .about-us-info p:nth-child(2), .about-us-info p:nth-child(3), .about-us-info p:nth-child(4), .about-us-info p:nth-child(5)",
      "sm",
    )
    .addTo(controller);
